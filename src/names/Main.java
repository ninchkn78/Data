...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(Test.namesWithHighestAverageRank(1880, 1890, "F"));
    System.out.println(Test.namesWithRank(2000, 2018, "F", 5));
    System.out.println(Test.mostFrequentRankedNames(2000, 2018, "F", 5));
    System.out.println(Test.mostCommonPrefixNames(2000, 2002, "M"));
    System.out.println(Test.topMaleAndFemaleName(2001, true));
  }
}
